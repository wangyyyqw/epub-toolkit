...
class ChineseConverter {
  ...
  static Future<void> initS2T() async {
    ...
    final phrasesData = await rootBundle.loadString(
      'assets/opencc/STPhrases.txt',
    );
    final charsData = await rootBundle.loadString(
  ...
  static String _matchDict(String text, Map<String, String> dict, int maxLen) {
