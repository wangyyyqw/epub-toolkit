...
class DownloadImagesPage extends StatefulWidget {
  const DownloadImagesPage({super.key});

  @override
  State<DownloadImagesPage> createState() => _DownloadImagesPageState();
}
...
class _DownloadImagesPageState extends State<DownloadImagesPage> {
  ...
  Future<void> _execute() async {
    ...
    _logController.append('PROGRESS: 开始执行「下载网络图片」操作...');
    ...
    try {
      ...
      if (mounted) context.read<ToastProvider>().showSuccess('下载完成');
    } catch (e) {
